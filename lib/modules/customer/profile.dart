  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<ServicesBlocRegistration,RegistrationStates>(
      ...
      builder: (context, states) {
        ...
        print(cubit.customerView!.customer!.firstName);
        print(cubit.customerView!.customer!.address);
        phoneNumber.text=cubit.customerView!.customer!.phone ?? 'null';
        genderController.text=cubit.customerView!.customer!.gender ??'null';
        return SafeArea(
          child: Scaffold(

            body: ConditionalBuilder(
              condition:cubit.customerView ==null,
